...
describe("ProfileComponent", () => {
  ...
  const mockImageUrl: string =
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRED0Wfr3ScQFESoWpiyZ1yBk1rFAj2laVCiQ&usqp=CAU";
  ...
  it("getProfileDetails shoulds return a userProfile object", fakeAsync(() => {
    ...
    let spy = spyOn(profileService, "getProfileDetails").and.returnValue(
      mockRes
    );
    fixture.detectChanges();
  ...
  it("profile renders an image container", () => {
    ...
    const imageContainer = debugElement.query(
      By.css("[data-testid=profile-image-container]")
    );
