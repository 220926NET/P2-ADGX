...
let MockLikeService = {
  getPostLike(postId:number):Observable<Like[]> {
    return of([{userId:0, postId:0}, {userId:0, postId:1}, {userId:0, postId:2}]);
  }
}
...
describe('PostLikeComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ PostLikeComponent, PostLikeCounterComponent, PostLikeButtonComponent ],
  ...
  it('should set like counter', () => {
    expect(fixture.nativeElement.querySelector('app-post-like-counter div')).toBeTruthy();
    expect(fixture.nativeElement.querySelector('app-post-like-counter div').innerText).toBe(component.likeList.length.toString());
  });

  it('should set button class to like', () => {
    expect(fixture.nativeElement.querySelector('app-post-like-button img')).toBeTruthy();
    expect(fixture.nativeElement.querySelector('app-post-like-button img').classList.contains('liked')).toBeTrue();
  });
