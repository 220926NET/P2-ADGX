...
public class BlobStorage
{
    ...
    private readonly BlobServiceClient _blobServiceClient = new BlobServiceClient(new Uri("https://storagetestrev.blob.core.windows.net"), new StorageSharedKeyCredential("storagetestrev", Secrets.GetStorageBlobKey()));
